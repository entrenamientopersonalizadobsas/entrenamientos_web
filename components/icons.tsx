...
export const DumbbellIcon = ({ className }: { className?: string }) => (
  ...
  >
    ...
    <path d="M18.657 21.071a2 2 0 1 1-2.828-2.828l-1.768-1.768a2 2 0 1 1-2.828-2.828l-1.768-1.768a2 2 0 1 1-2.828-2.828l5.656-5.657a2 2 0 1 1 2.828 2.828l1.768 1.768a2 2 0 1 1 2.828 2.828l1.768 1.768a2 2 0 1 1 2.828 2.828z" />
  </svg>
);
...
export const SleepIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className || "w-6 h-6"} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M5 12h2l4-8 4 8h2" />
        <path d="M5 20h2l4-8 4 8h2" />
    </svg>
);
...
export const NutritionIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className || "w-6 h-6"} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <path d="M7 2v20" />
        <path d="M15 12v10" />
        <path d="M15 5a2 2 0 0 0-2 2v3a2 2 0 0 0 2 2h0a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2h0z" />
    </svg>
);
...
export const BodyIcon = ({ className }: { className?: string }) => (
  ...
  >
    ...
    <path d="M12 8v5"></path>
    <path d="M18.5 10.5c-2.2 0-4-1.8-4-4v0"></path>
    <path d="M5.5 10.5c2.2 0 4-1.8 4-4v0"></path>
    <path d="M12 13l-2 8h8l-2-8z"></path>
  </svg>
);
