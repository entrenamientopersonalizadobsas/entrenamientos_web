    ...
    <div className="space-y-8 p-4 md:p-8">
      ...
      <section className="bg-gray-800 p-6 rounded-lg shadow-lg">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-x-8 gap-y-6">
          ...
          <div className="space-y-4">
            <h3 className="text-xl font-semibold text-yellow-400">Check-in Diario</h3>
             <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                 <CheckinControl label="Descanso" icon={<SleepIcon className="w-5 h-5" />} value={localDailyPlan.checkin.sueño} field="sueño" onChange={handleCheckinChange} />
                 <CheckinControl label="Nutrición" icon={<NutritionIcon className="w-5 h-5" />} value={localDailyPlan.checkin.comida} field="comida" onChange={handleCheckinChange} />
                 <CheckinControl label="Energía" icon={<EnergyIcon className="w-5 h-5" />} value={localDailyPlan.checkin.energia} field="energia" onChange={handleCheckinChange} />
             </div>
          </div>
        </div>
      </section>
